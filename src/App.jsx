...
// ==========================================
// 1. BASES DE DATOS SIMULADAS (MOCKS GLOBALES - REF: SHEET)
// ==========================================

const mockNotificaciones = [
  { id: 1, tipo: 'firma', titulo: 'Nueva Evaluación Técnica', mensaje: 'El Staff ha subido la evaluación mensual. Requiere Acuse de Recibo.', leida: false, firmada: false },
  { id: 2, tipo: 'alerta', titulo: 'Cuota Vencida', mensaje: 'Presenta 2 meses de atraso en Tesorería. Regularice su situación.', leida: false, firmada: true }
];

const mockAuditoria = [
  { id: 101, hora: "08:30", usuario: "Super Admin", accion: "Apertura de Sistema", detalle: "Inicio de jornada de fin de semana." },
  { id: 102, hora: "09:15", usuario: "Tesorero", accion: "Validación Pago", detalle: "Aprobado comprobante Familia Parra ($50.000)." },
...
const mockComunicaciones = [
  { id: 1, TITULO: "Suspensión de Entrenamiento", CUERPO_TEXTO: "Por reparaciones de la pista, el entrenamiento de hoy se traslada al Gimnasio B. Llegar 15 min antes.", FECHA: "07 Jul 2026", TIPO_COMUNICADO: "Suspensión", publico: true, audiencia: ['deportistas'], rama: 'Femenina', categoria: 'U15', urgencia: 'Alta', solicita_asistencia: false, reacciones: { '👍': 5, '❤️': 2, '😢': 1 }, asistencias: [] },
  { id: 2, TITULO: "Cena Anual de Recaudación", CUERPO_TEXTO: "Invitamos a todos los apoderados e hinchas a la gran cena de este viernes. Los fondos serán para nueva indumentaria.", FECHA: "05 Jul 2026", TIPO_COMUNICADO: "Evento", publico: true, audiencia: ['socios', 'apoderados'], rama: 'General', categoria: 'General', urgencia: 'Media', solicita_asistencia: true, reacciones: { '👍': 8, '❤️': 12 }, asistencias: [] },
  { id: 3, TITULO: "Resultados de Evaluaciones U15", CUERPO_TEXTO: "Los informes de evaluación técnica del mes de junio están disponibles para los jugadores inscritos en la sección Academia.", FECHA: "03 Jul 2026", TIPO_COMUNICADO: "Rendimiento", publico: false, audiencia: ['deportistas', 'apoderados'], rama: 'Masculina', categoria: 'U15', urgencia: 'Baja', solicita_asistencia: false, reacciones: { '👍': 3 }, asistencias: [] },
  { id: 4, TITULO: "Asamblea Extraordinaria de Socios", CUERPO_TEXTO: "Se convoca a todos los socios a la asamblea del próximo jueves a las 19:30 hrs. Temas: reforma estatutaria y presupuesto 2027.", FECHA: "08 Jul 2026", TIPO_COMUNICADO: "Asamblea", publico: false, audiencia: ['socios'], rama: 'General', categoria: 'General', urgencia: 'Crítica', solicita_asistencia: true, reacciones: { '👍': 6 }, asistencias: [] },
];

const mockFotos = [
  { id: 1, emoji: '🏀', titulo: 'Torneo U15 Valparaíso', fecha: '05 Jul 2026' },
...
// Colorimetría POS: 'Comida' (Naranja), 'Bebida' (Azul), 'Entradas' (Morado)
const productosKioscoBase = [
  { id: 1, nombre: 'Agua Mineral 500cc', costo: 400, precio: 1000, ventas: 45, emoji: '💧', stock: 4, categoria: 'Bebida' }, // Stock Crítico
  { id: 2, nombre: 'Bebida Zero 330cc', costo: 600, precio: 1500, ventas: 80, emoji: '🥤', stock: 40, categoria: 'Bebida' },
  { id: 3, nombre: 'Completo Italiano', costo: 800, precio: 2500, ventas: 110, emoji: '🌭', stock: 15, categoria: 'Comida' }, // Top Ventas
  { id: 4, nombre: 'Pizza (Trozo)', costo: 1000, precio: 2000, ventas: 12, emoji: '🍕', stock: 18, categoria: 'Comida' }, // Baja Venta
  { id: 5, nombre: 'Entrada General', costo: 0, precio: 2000, ventas: 150, emoji: '🎟️', stock: 300, categoria: 'Entradas' }
];

const mockTesoreriaDB = { 
  titular: "Familia Parra Silva", esSocio: true, estadoCuenta: "Moroso", mesesAtraso: 2, utmValor: 71506, textoUTM: "Cálculo fijado a la UTM del mes anterior (30 Junio 2026).",
  pupilos: [
    { id: 201, nombre: "Tomás Parra", categoria: "U15 Masculino", nivel: 12, xp: 2450 },
...
const partidosPrueba = [
  { id: 1, fecha: "06 Jul 2026", rama: "Femenina", torneo: "Asoc. Valparaíso", categoria: "U15 Femenino", miEquipo: 68, rival: 52, nombreRival: "Los Leones" },
  { id: 2, fecha: "04 Jul 2026", rama: "Masculina", torneo: "Asoc. Valparaíso", categoria: "U17 Masculino", miEquipo: 60, rival: 65, nombreRival: "Sportiva Italiana" }
];
...
const mockEvaluacion = [
  ...
  { subject: 'Dribbling', score: 75, fullMark: 100 }, { subject: 'Físico', score: 80, fullMark: 100 }, 
  { subject: 'Táctica', score: 88, fullMark: 100 }
];

const mockQuiz = { 
  TITULO_LECCION: "Desmarque en Ofensiva", PREGUNTA: "¿Cuál es el objetivo principal de un 'Corte en V' (V-Cut)?", 
  OPCION_A: "Tirar inmediatamente de tres puntos.", OPCION_B: "Engañar al defensor para recibir el balón libre.", 
  OPCION_C: "Cometer una falta intencional.", RESPUESTA_CORRECTA: "B", 
  EXPLICACION_RESPUESTA: "¡Correcto! El Corte en V lleva a tu defensor en una dirección para luego cambiar bruscamente." 
};

const mockMorosos = [
  { id: 1, nombre: 'Familia García López', tipo: 'socio-apoderado', mesesDeuda: 3, montoDeuda: 198000, contacto: '+56 9 1234 5678', pupilos: ['Carlos García — U15M'] },
  { id: 2, nombre: 'Juan Rodríguez P.', tipo: 'socio', mesesDeuda: 4, montoDeuda: 132000, contacto: '+56 9 8765 4321', pupilos: [] },
  { id: 3, nombre: 'Familia Torres M.', tipo: 'apoderado', mesesDeuda: 1, montoDeuda: 30000, contacto: '+56 9 1122 3344', pupilos: ['Sofía Torres — U13F'] },
  { id: 4, nombre: 'Familia Ramos Díaz', tipo: 'socio-apoderado', mesesDeuda: 2, montoDeuda: 130000, contacto: 'ramos.fam@mail.com', pupilos: ['Diego Ramos — U17M'] },
