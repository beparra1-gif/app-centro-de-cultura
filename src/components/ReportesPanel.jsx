  ...
  return (
    <div className="mt-20">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px', gap: '10px', flexWrap: 'wrap' }}>
        <h4 style={{ color: 'var(--texto-heading)', margin: 0, fontSize: '18px', fontWeight: '900' }}>📊 Reportes de Actividad</h4>
      ...
      <div className="segment-control mb-20" style={{ background: 'rgba(255,255,255,0.88)', flexWrap: 'wrap', gap: '4px', borderRadius: '18px', padding: '4px' }}>
